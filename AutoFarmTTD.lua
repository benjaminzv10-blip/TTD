...
local function StartAntiStuck()
    task.spawn(function()
        ...
        while true do
            ...
            if stillTime >= maxStillTime then
                warn("Standing still too long, rejoining...")
                Rejoin()
                break
            end
...
local function runPlaceB()
    ...
    task.spawn(function()
        while true do
            if startButton
                and startButton:IsA("GuiButton")
                and startButton.Visible
                and startButton.Parent.Visible then
